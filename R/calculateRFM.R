...
#'
#'Description
#'   Calculate a weighted RFM score: recency, frequency, and monetary value for every customer
#'
#'Arguments
#'@param data - A data.table containing the transaction recorded details for every customer.
